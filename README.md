...
- [testthedocs/Openly](https://github.com/testthedocs/Openly) - A Vale linter style that aims to replicate Grammarly in an open-source, privacy-friendly way
...
- [cloud-ark/kubeplus](https://github.com/cloud-ark/kubeplus) - Kubernetes Operator to create multi-instance SaaS from Helm charts using Kubernetes-native APIs
...
- [BugDiver/gauge-ts](https://github.com/BugDiver/gauge-ts) - Typescript language plugin for Gauge
...
- [solidsnail/readme-jsx](https://github.com/solidsnail/readme-jsx) - Create beautiful HD readme content with ease
...
- [confluentinc/kafka-rest-node](https://github.com/confluentinc/kafka-rest-node) - Node.js client for the Kafka REST proxy
...
- [dmvaldman/samsara](https://github.com/dmvaldman/samsara) - ☸️  Continuous UI
...
- [auditassistant/json-query](https://github.com/auditassistant/json-query) - Retrieves values from JSON objects for data binding
...
- [emcf/thepipe](https://github.com/emcf/thepipe) - Feed PDFs, docs, slides, web pages and more into GPT-4-Vision in one line of code ⚡
...
- [Multiwoven/multiwoven](https://github.com/Multiwoven/multiwoven) - 🔥 Open Source Reverse ETL and Customer Data Platform (CDP). An open-source alternative to Hightouch, Census, and RudderStack.
...
- [johnsoncodehk/tsslint](https://github.com/johnsoncodehk/tsslint) - 
...
- [dbos-inc/dbos-transact](https://github.com/dbos-inc/dbos-transact) - The Transactional TypeScript Framework
...
- [automock/automock](https://github.com/automock/automock) - Easier Unit Testing for TypeScript Dependency Injection Frameworks
...
- [elegantframework/elegant-cli](https://github.com/elegantframework/elegant-cli) - :purple_heart:   Build SEO-friendly websites, super fast full-stack web applications, and much more with Elegant. Built with Next.js, Tailwind CSS, Outstatic, and more.
...
- [metatypedev/metatype](https://github.com/metatypedev/metatype) - Declarative API development platform. Build backend components with WASM/Typescript/Python, no matter where and how your (legacy) systems are.
...
- [commitspark/graphql-api](https://github.com/commitspark/graphql-api) - GraphQL API for the Commitspark CMS
...
- [ink-zone/fower](https://github.com/ink-zone/fower) - A utility-first CSS in JS library
...
- [mtford90/react-native-watch-connectivity](https://github.com/mtford90/react-native-watch-connectivity) - Enable communication between apple watch app and react native
